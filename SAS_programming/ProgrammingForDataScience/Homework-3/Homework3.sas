...
DATA Homework3;
INFILE "E:\SASProgrammingPractice\Homework3\babies.txt";
...
TABLES sex prenatalcare smokestatus preterm term lowBW normalBW largeBW;
...
PROC FREQ DATA=Homework3;
TABLES preterm*(lowBW normalBW largeBW sex prenatalcare smokestatus);
...
LIBNAME cesd "E:\SASProgrammingPractice\Homework3";
...
becomes a value of 0.;
	...
	DO i = 1 to 4;
	cesditnew(i) = 4 - cesditnew(i);
	END;
* c) Create the CES-D total score by summing upitems in the 16 non-reversed items and the 4 reversed items;

	cesdtot = sum(CESD1,CESD2,CESD3,CESD5,CESD6,CESD7,CESD9,CESD10,CESD11,CESD13,CESD14,CESD15,CESD17,CESD18,
